...
Changelog.VERSIONS = {
    {
        ...
        Date = "2026-08-11",
        Changes = {
            { "Added", "Checkpoint Scan (Anti Geser): setelah TP, player diputar 1-10 stud di sekitar checkpoint biar tetap kehitung walau game menggeser koordinatnya" },
            { "Added", "6 scan method: Orbit Spiral, Cross Axis, Vertical Sweep, Grid Cube, Random Jitter, Dwell Hover" },
            { "Added", "Pengaturan scan: speed/delay per titik, radius awal-akhir, radius step, titik per ring, offset vertikal + layer, timeout per checkpoint" },
            { "Added", "Auto stop scan kalau progress leaderstats berubah (checkpoint terdeteksi kena)" },
            { "Added", "Anchor velocity saat scan (anti jatuh), balik ke titik tengah setelah scan" },
            { "Added", "Tombol Scan Checkpoint Terpilih & Stop Scan, plus opsi scan saat teleport manual" },
        },
    },
